	...
	return (
		<Dialog open={open} fullWidth maxWidth={"xs"}>
			...
			<DialogContent>
				...
				<TextField fullWidth label={"Username"} value={username} sx={{ my: 1 }}
			...
			<DialogActions>
				<Button autoFocus onClick={handleCancel} disabled={loading}>Cancel</Button>
				<Button onClick={handleSubmit} disabled={loading || !isValid()}>Add friend</Button>
			</DialogActions>
		</Dialog>
	);
}